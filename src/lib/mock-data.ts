...
export const LISTINGS: Listing[] = [
  ...
  { id: 'lp2', title: 'Dell XPS 15 InfinityEdge', price: 28500, oldPrice: 32000, isNegotiable: false, category: 'Electronics', subcategory: 'Laptops', location: 'Cantonments', postedAt: '2h ago', postedTimestamp: Date.now(), imageUrl: 'https://picsum.photos/seed/gh-lp2/800/1000', imageHint: 'laptop', vendorId: 'v1', description: 'Stunning OLED 4K display, Core i9 processor. Ideal for professionals and creatives. Brand new, sealed box.', status: 'Active', isEscrowProtected: true, specs: ['Core i9', '16GB RAM', 'OLED 4K'], seller: DEFAULT_SELLER, condition: 'New', viewCount: 412, saveCount: 8, inquiryCount: 5 },
  { id: 'lp3', title: 'HP Spectre x360 Convertible', price: 18000, isNegotiable: true, category: 'Electronics', subcategory: 'Laptops', location: 'East Legon', postedAt: 'Just Now', postedTimestamp: Date.now(), imageUrl: 'https://picsum.photos/seed/gh-lp3/800/1000', imageHint: 'laptop', vendorId: 'v1', description: '360-degree touchscreen convertible laptop. Perfect for presentations, drawing, and everyday use.', status: 'Active', isEscrowProtected: true, specs: ['Core i7', '16GB RAM', 'Touchscreen'], seller: DEFAULT_SELLER, condition: 'New', viewCount: 193, saveCount: 4, inquiryCount: 2 },
  { id: 'lp4', title: 'Lenovo ThinkPad X1 Carbon Gen 11', price: 22000, isNegotiable: false, category: 'Electronics', subcategory: 'Laptops', location: 'Ridge', postedAt: 'Yesterday', postedTimestamp: Date.now(), imageUrl: 'https://picsum.photos/seed/gh-lp4/800/1000', imageHint: 'laptop', vendorId: 'v1', description: 'Ultra-light carbon fibre laptop with military-grade durability. Fingerprint reader and IR camera included.', status: 'Active', isEscrowProtected: true, specs: ['vPro i7', '32GB RAM', 'Carbon Fibre'], seller: DEFAULT_SELLER, condition: 'New', viewCount: 334, saveCount: 11, inquiryCount: 7 },
  { id: 'lp5', title: 'ASUS ROG Zephyrus G14 Gaming', price: 15500, isNegotiable: true, category: 'Electronics', subcategory: 'Laptops', location: 'Spintex', postedAt: 'Today', postedTimestamp: Date.now(), imageUrl: 'https://picsum.photos/seed/gh-lp5/800/1000', imageHint: 'laptop', vendorId: 'v1', description: 'Compact 14-inch gaming powerhouse with RTX 4060 graphics. Runs AAA games and creative workloads with ease.', status: 'Active', isEscrowProtected: true, specs: ['Ryzen 9', 'RTX 4060', '120Hz'], seller: DEFAULT_SELLER, condition: 'New', viewCount: 621, saveCount: 19, inquiryCount: 9 },
  // MOBILES
  ...
  { id: 'ph2', title: 'Samsung Galaxy S24 Ultra', price: 17800, isNegotiable: true, category: 'Electronics', subcategory: 'Mobiles', location: 'Osu', postedAt: '1h ago', postedTimestamp: Date.now(), imageUrl: 'https://picsum.photos/seed/gh-ph2/800/1200', imageHint: 'samsung', vendorId: 'v1', description: 'Galaxy AI-powered flagship with built-in S Pen. 200MP camera, 5000mAh battery. Direct from authorized dealer.', status: 'Active', isEscrowProtected: true, seller: DEFAULT_SELLER, condition: 'New', viewCount: 987, saveCount: 32, inquiryCount: 18 },
  ...
  { id: 'ph4', title: 'OnePlus 12 Emerald Forest', price: 11000, isNegotiable: true, category: 'Electronics', subcategory: 'Mobiles', location: 'Tema', postedAt: 'Today', postedTimestamp: Date.now(), imageUrl: 'https://picsum.photos/seed/gh-ph4/800/1200', imageHint: 'oneplus', vendorId: 'v1', description: '100W SuperVOOC fast charging — fully charged in 26 minutes. Snapdragon 8 Gen 3, 50MP Hasselblad camera.', status: 'Active', isEscrowProtected: true, seller: DEFAULT_SELLER, condition: 'New', viewCount: 312, saveCount: 7, inquiryCount: 3 },
  { id: 'ph5', title: 'Nothing Phone (2)', price: 8500, isNegotiable: false, category: 'Electronics', subcategory: 'Mobiles', location: 'East Legon', postedAt: 'Just Now', postedTimestamp: Date.now(), imageUrl: 'https://picsum.photos/seed/gh-ph5/800/1200', imageHint: 'nothing', vendorId: 'v1', description: 'Unique transparent design with Glyph Interface LED system. Clean Android experience. Sealed, brand new.', status: 'Active', isEscrowProtected: true, seller: DEFAULT_SELLER, condition: 'New', viewCount: 178, saveCount: 5, inquiryCount: 2 },
  // VEHICLES
