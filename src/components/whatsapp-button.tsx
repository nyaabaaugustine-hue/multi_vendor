...
/**
 * @fileOverview Floating WhatsApp Support Button
 * Provides instant institutional support access via the WhatsApp protocol.
 */
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="text-[8px] font-black mt-1 md:mt-2 tracking-widest uppercase">Support</span>
    </a>
  );
}
